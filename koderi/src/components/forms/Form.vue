<template>
    <v-card elevation="0">
      <v-card-title class="title font-weight-regular justify-space-between">
        <span class="krok-text"><strong>Krok {{step}}</strong> /3</span>
      </v-card-title>
      <v-form ref="form" v-model="formIsValid" >
        <v-window v-model="step">
          <v-window-item :value="1">
            <v-card-text>
                <p class="form-lead-paragraph">V prvom kroku je dôležité zistiť to,<br> aký kóder ste a koľko reálnych skúseností máte.</p>
                <p class="headline-question">Aký typ kódera ste?</p>
                <v-layout row class="mb-4">
                    ...
                    <p class="headline-question">Ktoré technológie sú vám blízke?</p>
                    ...
                    <div v-if="programmer.selectedTechnologies.includes(6)">
                        <p class="headline-question">Aký Javascript framework používate?</p>
                        <v-layout  row wrap class="mb-4">
                          <v-flex xs6>
                            <v-chip label color="white" 
                    ...
                    <p class="headline-question">Koľko rokov praxe máte?</p>
                    <v-layout row wrap class="mb-4">
                      <v-flex xs6>
                        <v-chip color="white"
          ...
          <v-window-item :value="2">
            <v-card-text>
              <p class="form-lead-paragraph">V druhom kroku uveďte doplňujúce informácie.</p>
              <p class="headline-question">Viedli ste niekedy tím ľudí?</p>
              <v-layout class="mb-4">
                <v-flex xs6>
              ...
              <p class="headline-question">Máte skúsenosti s konkrétnou doménou? (Bankovníctvo, Medicína, Telekomunikácie...)</p>
              <v-layout class="mb-4">
                <v-flex xs6>
              ...
              <p class="headline-question">Pracovali ste ako softvérový architekt?</p>
              <v-layout class="mb-4">
                <v-flex xs6>
          ...
          <v-window-item :value="3">
            <v-layout>
              <v-flex xs6>
                <v-card-text>
                  <p class="form-lead-paragraph">Nakoniec nám nechajte svoje meno a e-mail, na ktorý Vám pošleme výsledok formulára.</p>
      ...
      <v-card-actions>
        ...
        <v-btn class="btn-success-color white--text" depressed @click="processStep()">{{step==3 ? 'ODOSLAŤ' : 'ĎALEJ' }}</v-btn>
      </v-card-actions>
      <!-- left unused -->
...
.v-chip--selected, .v-chip{
  box-shadow: none !important;
}
.btn-success-color{
  background-color : #4297F9 !important;
}
</style>
